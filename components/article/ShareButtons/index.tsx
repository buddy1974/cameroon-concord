...
export default function ShareButtons({ title, categorySlug, slug }: Props) {
  ...
  const btn = (href: string, bg: string, border: string, label: string, icon: React.ReactNode) => (
